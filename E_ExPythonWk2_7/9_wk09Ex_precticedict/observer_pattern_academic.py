...
class CouseData(Subject, Displayable):
    def __init__(self):
        self.__observers = []
    ...
    def averageAttendence(self, value):
    ...
    def display(self):
        print('Average Attendence = ', self.__averageAttendence)
        print('Average Attendence = ', self.__averageScore)
